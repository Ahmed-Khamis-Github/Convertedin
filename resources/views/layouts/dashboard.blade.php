...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ 'Convertedin' }}</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('dashboard.statistics.index') }}"
                class="nav-link {{ request()->routeIs('dashboard.statistics.*') ? 'active' : '' }}">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2024 <a href="https://adminlte.io">{{ 'Laravel'}}</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
